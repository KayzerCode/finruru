...
<div align="center"><form action="delete_component_potpokr_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_potpokr.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_potpokr=<?php echo $row['id_potpokr'];?>'" />
</form></div><br /><br /><br />

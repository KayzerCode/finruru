...
$result = mysql_query("SELECT * FROM `polobr` WHERE `id` = $id", $link);
	...
	<tr>
    	<td>
        	<div align="left"><a href="show_polobr.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_polobr=<?php echo $id;?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="delete_element_polobr_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_polobr.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_polobr=<?php echo $id;?>'" />
</form></div><br /><br /><br />

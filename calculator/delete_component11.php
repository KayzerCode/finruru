...
<div align="center"><form action="delete_component_isp11.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_component5.php?show_comp_id=<?php echo $id;?>&amp;elid=<?php echo $elid;?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" />
</form></div><br /><br /><br />

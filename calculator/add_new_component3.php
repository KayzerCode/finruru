...
$pos = $row_max1['position'] + 1;?>
	...
	<tr>
    	<td>
        	<div align="left"><a href="add_stena.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="К списку имеющихся слоёв"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="add_new_component_isp3.php" enctype="multipart/form-data" method="post">
...
<tr>
	<td colspan="2" align="center">
    <input type="submit" align="middle" value="Создать" /><input type="button" value="Отмена" onclick="location.href='add_stena.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" title="Отменить и вернуться к списку имеющихся слоёв"/>
    </td>
    </tr>
    </tr>
</table>

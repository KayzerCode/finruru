...
<!--Center block-->
		...
		<?php include ("show_foto_shablon.php"); // For rooms?>
        
		<?php include ("show_room.php"); // For rooms?>

		<?php include ("calc_otd.php"); // For finishing?>
        
        <?php include ("calc_other.php"); // For others not_finishing?>

...
$result = mysql_query("SELECT * FROM `components_polpokr` WHERE `id` = $id", $link);
...
<div align="center"><form action="delete_component_polpokr_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_polpokr.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_polpokr=<?php echo $row['id_polpokr'];?>'" />
</form></div><br /><br /><br />

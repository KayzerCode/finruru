...
<div align="center"><form action="delete_component_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_elements.php?id=<?php echo $row['elid'];?>'" />
</form></div><br /><br /><br />

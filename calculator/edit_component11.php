...
<table cellspacing="10">
	<tr>
    	<td>
        	<div align="left"><a href="show_component5.php?show_comp_id=<?php echo $id;?>&amp;elid=<?php echo $elid;?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="edit_component_isp11.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='show_component5.php?show_comp_id=<?php echo $id;?>&amp;elid=<?php echo $elid;?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" title="Отменить и вернуться к слою"/>
</form></div>
...
<a href="delete_foto11.php?id=<?php echo $row['id']; ?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

...
$result = mysql_query("SELECT * FROM `handbook_elements` WHERE `id` = $id", $link);
	...
	<tr>
    	<td>
        	<div align="left"><a href="show_elements.php?id=<?php echo $id;?>" title="Назад к списку слоёв"><?php include ("button_back.php");?></a></div>
        </td>
...
<div align="center"><form action="edit_element_isp1.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Редактировать"/><input type="button" value="Отмена" onclick="location.href='show_elements.php?id=<?php echo $id;?>'" title="Отменить и вернуться к списку имеющихся слоёв"/>
</form></div><br /><br /><br />

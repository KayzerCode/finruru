...
$pos = $row_max1['position'] + 1;?>
	...
	<tr>
    	<td>
        	<div align="left"><a href="add_elements.php?id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>" title="К списку имеющихся слоёв"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="add_new_component_other_isp.php" enctype="multipart/form-data" method="post">
...
<tr>
	<td colspan="2" align="center">
    <input type="submit" align="middle" value="Создать" /><input type="button" value="Отмена" onclick="location.href='add_elements.php?id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>'" title="Отменить и вернуться к списку имеющихся слоёв"/>
    </td>
    </tr>
    </tr>
</table>

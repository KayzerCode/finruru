...
<div align="center"><form action="delete_component_polpokr_isp1.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_component_polpokr.php?show_comp_id=<?php echo $row['id'];?>&amp;id=<?php echo $row['id_shab']?>'" />
</form></div><br /><br /><br />

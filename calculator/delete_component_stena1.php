...
<div align="center"><form action="delete_component_stena_isp1.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_component_stena.php?show_comp_id=<?php echo $row['id'];?>&amp;id=<?php echo $row['id_shab']?>'" />
</form></div><br /><br /><br />

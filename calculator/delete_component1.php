...
<div align="center"><form action="delete_component_isp1.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_component.php?show_comp_id=<?php echo $id;?>&amp;elid=<?php echo $row['elid'];?>'" />
</form></div><br /><br /><br />

...
<div align="center"><form action="delete_component_isp8.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='add_potpokr.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" />
</form></div><br /><br /><br />

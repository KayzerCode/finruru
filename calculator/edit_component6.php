...
<div align="center"><form action="edit_component_isp6.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='add_stena.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" title="Отменить и вернуться к слою"/>
</form></div>
...
<a href="delete_foto6.php?id=<?php echo $row['id']; ?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

...
<div align="center"><form action="delete_element_other_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='add_elements.php?id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>'" />
</form></div><br /><br /><br />

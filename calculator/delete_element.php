...
$result = mysql_query("SELECT * FROM `handbook_elements` WHERE `id` = $id", $link);
	...
	<tr>
    	<td>
        	<div align="left"><a href="handbook.php?group=<?php echo $row['group'];?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="delete_element_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='handbook.php?group=<?php echo $row['group'];?>'" />
</form></div><br /><br /><br />

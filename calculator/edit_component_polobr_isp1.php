...
$result1 = mysql_query("UPDATE `components_polobr` SET `name` = ('" . $componentnaz .  "') WHERE `id` = ('" . $id .  "')");

$result2 = mysql_query("UPDATE `components_polobr` SET `razm` = ('" . $razm .  "') WHERE `id` = ('" . $id .  "')");

$result3 = mysql_query("UPDATE `components_polobr` SET `stmat` = ('" . $stmat .  "') WHERE `id` = ('" . $id .  "')");

$result4 = mysql_query("UPDATE `components_polobr` SET `strab` = ('" . $strab .  "') WHERE `id` = ('" . $id .  "')");

$result5 = mysql_query("UPDATE `components_polobr` SET `stsopmat` = ('" . $stsopmat .  "') WHERE `id` = ('" . $id .  "')");

$result6 = mysql_query("UPDATE `components_polobr` SET `trud` = ('" . $trud .  "') WHERE `id` = ('" . $id .  "')");
...
$result = mysql_query("UPDATE `components_polobr` SET `foto` = '".$filename."' WHERE `id` =" .$id, $link);
...
header("Location: show_component_polobr.php?show_comp_id=" . $id . "&id=" . $id_shab);

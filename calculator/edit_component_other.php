...
<div align="center"><form action="edit_component_other_isp.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='add_elements.php?id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>'" title="Отменить и вернуться к слою"/>
</form></div>
...
<a href="delete_foto_other.php?id=<?php echo $row['id']; ?>&amp;id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

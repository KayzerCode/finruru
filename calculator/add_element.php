...
if(get_magic_quotes_gpc()){ 
	...
	<tr>
    	<td>
        	<div align="left"><a href="handbook.php?group=<?php echo $group;?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="add_element_isp.php"  enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Создать"/><input type="button" value="Отмена" onclick="location.href='handbook.php?group=<?php echo $group;?>'" />
</form></div><br /><br /><br />

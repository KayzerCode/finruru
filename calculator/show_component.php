...
<table cellspacing="10" align="left">
	<tr>
    	<td>
        	<div align="left"><a href="show_elements.php?id=<?php echo $elid;?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table><br /><br />
<div align="center">Компонент <font color="#FF9966" size="+2"><?php echo $row['name']; ?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_component1.php?id_edit_comp=<?php echo $row['id'];?>" title="Редактировать"><?php include ("button_edit.php");  // the button edit?></a><a href="delete_component1.php?id_del_comp=<?php echo $row['id'];?>" title="Удалить"><?php include ("button_delete.php");  // the button delete?></a></div><br /><br />
<table align="center">
<tr>
	<td>

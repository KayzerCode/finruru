...
<div align="center"><form action="delete_component_shablon_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_element_other.php?id=<?php echo $row['id_shab'];?>&amp;elid=<?php echo $row['elid'];?>&amp;group=<?php echo $row['group']?>'" />
</form></div><br /><br /><br />

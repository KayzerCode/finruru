...
$result = mysql_query("SELECT * FROM `handbook_elements` WHERE `id` = $id", $link);
	...
	<tr>
    	<td>
        	<div align="left"><a href="add_polobr.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="Назад к списку элементов"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="edit_element_isp3.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Редактировать"/><input type="button" value="Отмена" onclick="location.href='add_polobr.php?id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>'" title="Отменить и вернуться к списку элементов"/>
</form></div><br /><br /><br />
...
<a href="delete_foto_elem3.php?id=<?php echo $row['id']; ?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div><br />
<?php } ?>

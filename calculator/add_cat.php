...
<div align="center"><form action="add_cat_isp.php" method="post">
<input type="hidden" name="id_shab" value="<?php echo $id;?>" />
<div align="center"><font color="#000000" size="+1"><em>Введите название новой категории:&nbsp;&nbsp;&nbsp;</em></font></div><br />
&nbsp;&nbsp;&nbsp;<input type="text" name="elnaz" size="45"><br /><br />
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Создать"/><input type="button" value="Отмена" onclick="location.href='calc_shab.php?id=<?php echo $id;?>'" />
</form></div><br /><br /><br />

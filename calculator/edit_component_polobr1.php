...
<table cellspacing="10">
	<tr>
    	<td>
        	<div align="left"><a href="show_component_polobr.php?show_comp_id=<?php echo $row['id'];?>&amp;id=<?php echo $row['id_shab']?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="edit_component_polobr_isp1.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='show_component_polobr.php?show_comp_id=<?php echo $row['id'];?>&amp;id=<?php echo $row['id_shab']?>'" title="Отменить и вернуться к списку имеющихся элементов"/>
</form></div>
...
<a href="delete_foto_comp_polobr1.php?id=<?php echo $row['id']; ?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

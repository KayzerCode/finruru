...
<div align="center"><form action="add_element_other_isp.php"  enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Создать"/><input type="button" value="Отмена" onclick="location.href='add_elements.php?id_shab=<?php echo $id_shab;?>&amp;group=<?php echo $group;?>'" />
</form></div><br /><br /><br />

...
if(get_magic_quotes_gpc()){ 
            $id_comp = stripslashes($_GET['show_comp_id']);
            $id = stripslashes($_GET['id']);

        } else { 
            $id_comp = addslashes($_GET['show_comp_id']);
...
$result = mysql_query("SELECT * FROM `shab_components` WHERE `id` = $id_comp ");
...
<div align="center">Компонент <font color="#FF9966" size="+2"><?php echo $row['name']; ?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_component_shablon1.php?id_edit_comp=<?php echo $row['id'];?>" title="Редактировать"><?php include ("button_edit.php");  // the button edit?></a><a href="delete_component_shablon1.php?id_del_comp=<?php echo $row['id'];?>" title="Удалить"><?php include ("button_delete.php");  // the button delete?></a></div><br /><br />
<table align="center">
<tr>
	<td>

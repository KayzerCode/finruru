...
<?php } else {
                ...
                Фотографию можно добавить через страницу редактирования элемента <a href="edit_element6.php?id=<?php echo $id;?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>" title="Редактировать элемент"><?php include ("button_edit.php");  // the button edit?></a></div><?php

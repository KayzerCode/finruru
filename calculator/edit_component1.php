...
<table cellspacing="10">
	<tr>
    	<td>
        	<div align="left"><a href="show_component.php?show_comp_id=<?php echo $id;?>&elid=<?php echo $row['elid'];?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="edit_component_isp1.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='show_component.php?show_comp_id=<?php echo $id;?>&elid=<?php echo $row['elid'];?>'" title="Отменить и вернуться к слою"/>
</form></div>
...
<a href="delete_foto1.php?id=<?php echo $row['id']; ?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

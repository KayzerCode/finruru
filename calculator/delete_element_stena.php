...
$result = mysql_query("SELECT * FROM `stena` WHERE `id` = $id", $link);
	...
	<tr>
    	<td>
        	<div align="left"><a href="show_stena.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_stena=<?php echo $id;?>"><?php include ("button_back.php");?></a></div>
        </td>
    </tr>
</table>
<div align="center"><form action="delete_element_stena_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_stena.php?id=<?php echo $row['id_shab'];?>&amp;id_room=<?php echo $row['id_room'];?>&amp;id_stena=<?php echo $id;?>'" />
</form></div><br /><br /><br />

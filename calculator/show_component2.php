...
<div align="center">Компонент <font color="#FF9966" size="+2"><?php echo $row['name']; ?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_component5.php?id_edit_comp=<?php echo $row['id'];?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>&amp;elid=<?php echo $elid;?>" title="Редактировать"><?php include ("button_edit.php");  // the button edit?></a><a href="delete_component5.php?id_del_comp=<?php echo $row['id'];?>&amp;id_shab=<?php echo $id_shab;?>&amp;id_room=<?php echo $id_room;?>&amp;elid=<?php echo $elid;?>" title="Удалить"><?php include ("button_delete.php");  // the button delete?></a></div><br /><br />
<table align="center">
<tr>
	<td>

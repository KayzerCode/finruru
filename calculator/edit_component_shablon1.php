...
<div align="center"><form action="edit_component_shablon_isp1.php" enctype="multipart/form-data" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Сохранить"/><input type="button" value="Отмена" onclick="location.href='show_component_shablon.php?id=<?php echo $row['id_shab'];?>&amp;show_comp_id=<?php echo $id;?>'" title="Отменить и вернуться к списку имеющихся элементов"/>
</form></div>
...
<a href="delete_foto_comp_shablon1.php?id=<?php echo $id; ?>" title="Удалить картинку"><?php include ("button_delete_component.php");?></a></div>
<?php } ?>

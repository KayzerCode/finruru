...
<div align="center"><form action="delete_element_shablon_isp.php" method="post">
...
&nbsp;&nbsp;&nbsp;<input type="submit" align="middle" value="Удалить" title="Удалить"/><input type="button" value="Отмена" onclick="location.href='show_element_other.php?elid=<?php echo $elid;?>&amp;id=<?php echo $id;?>&amp;group=<?php echo $group;?>'" />
</form></div><br /><br /><br />
